    ...
    return (
        <div className="w-full mt-0 bg-black/40 rounded-2xl border border-white/10 p-4 h-full flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="relative group shrink-0">
                <input
                    aria-label="Experience log entry"
                    type="text"
                    value={newComment}
                    ...
                    className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-4 pr-12 text-white font-mono text-[10px] focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus:border-accent/50 transition-all placeholder:text-white/20 disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                        ...
                        <div className="lobby-item flex flex-col items-center justify-center bg-black/20 rounded-xl p-4 border border-white/5">
                            ...
                            <div className="flex items-center gap-2 w-full bg-black/40 p-2 rounded-lg border border-white/10">
                                ...
                                <input
                                    ...
                                    className="bg-transparent text-white font-mono text-xs focus:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded px-1 w-full uppercase"
                                />
                            </div>
                        </div>
                    </div>
