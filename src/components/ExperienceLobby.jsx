...
const TabButton = ({ id, activeTab, setActiveTab, label, icon: IconComponent }) => {
    ...
    return (
        <button
            ...
            className={`flex-1 pb-3 pt-2 text-[10px] md:text-xs font-mono uppercase tracking-widest border-b-2 transition-all flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:z-10 ${activeTab === id
...
const PillButton = ({ active, onClick, children, tooltip, className = '' }) => (
    <Tooltip text={tooltip}>
        <button
            aria-pressed={active}
            onClick={onClick}
            className={`w-full py-3 px-3 rounded-xl border transition-all font-mono text-[9px] md:text-[10px] uppercase tracking-wider flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:z-10 ${active
