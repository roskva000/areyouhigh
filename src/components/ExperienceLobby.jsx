...
const TabButton = ({ id, activeTab, setActiveTab, label, icon: IconComponent }) => {
    ...
    return (
        <button
            ...
            className={`flex-1 pb-3 pt-2 text-[10px] md:text-xs font-mono uppercase tracking-widest border-b-2 transition-all flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:bg-white/10 ${activeTab === id
                            ...
                            <div className="flex flex-col gap-2">
                                {customPalettes.map((p) => (
                                    <button
                                        ...
                                        className={`w-full group relative py-3 px-4 rounded-xl border transition-all flex items-center gap-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50 ${activePaletteId === p.id
            ...
            <div className="lobby-content relative w-full max-w-[1200px] bg-zinc-950/90 backdrop-blur-3xl border border-white/10 rounded-[2rem] md:rounded-[2.5rem] p-4 md:p-6 shadow-[0_0_100px_rgba(0,0,0,0.9)] h-[90vh] md:h-[85vh] flex flex-col overflow-hidden">
                ...
                <div className="flex-1 min-h-0 flex flex-col md:flex-row gap-6 md:gap-8 overflow-hidden relative z-0">
                    ...
                    <div className="w-full md:w-2/3 flex flex-col min-h-0 bg-black/20 rounded-2xl border border-white/5">
                        {/* Tabs */}
                        <div className="flex border-b border-white/10 shrink-0" role="tablist" aria-label="Experience customization options">
