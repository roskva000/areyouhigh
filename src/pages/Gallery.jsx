...
export default function Gallery() {
    ...
    // ⚡ Bolt: Optimize list filtering using short-circuit evaluation.
    // We check the less expensive, exact category match first before executing
    // more costly string operations. We also hoist toLowerCase() and memoize.
    const filteredGroups = useMemo(() => {
        const searchLower = search.toLowerCase();
        return masterGroups.filter(group => {
            const matchesCategory = activeCategory === 'All' || group.category === activeCategory;
            // Short-circuit: if category doesn't match, skip string operations entirely
