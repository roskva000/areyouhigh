...
export default function Gallery() {
    ...
    // ⚡ Bolt: Memoize filtering and sorting to prevent expensive recalculations during unrelated renders (e.g., animations)
    // Also use deferredSearch to prevent input lag
    const sortedGroups = useMemo(() => {
        // ⚡ Bolt: Hoist toLowerCase calculation outside the filter loop
        const lowerSearch = deferredSearch.toLowerCase();

        const filtered = masterGroups.filter(group => {
            // ⚡ Bolt: Short-circuit with fast category equality check before expensive string operations
