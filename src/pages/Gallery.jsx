...
export default function Gallery() {
    ...
    // Memoize filtered and sorted groups to avoid expensive operations on re-renders
    const sortedGroups = useMemo(() => {
        const lowerSearch = search.toLowerCase(); // Hoist lowercase conversion outside the loop
