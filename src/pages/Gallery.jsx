...
export default function Gallery() {
    ...
    const filteredGroups = useMemo(() => {
        ...
        return masterGroups.filter(group => {
            // ⚡ Bolt Optimization: Short-circuit list filtering by checking less expensive,
            // exact matches (category) before executing costly string operations (toLowerCase/includes).
