...
export default function Gallery() {
    ...
    // Memoize filtered groups and hoist search.toLowerCase() to avoid redundant string conversions during iteration
    ...
    // Memoize sorted groups to prevent redundant sorting operations
