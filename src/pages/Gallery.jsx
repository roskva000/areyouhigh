...
export default function Gallery() {
    ...
    // ⚡ Bolt: Memoize to prevent O(N) operations on every render
    const categories = useMemo(() => ['All', ...new Set(masterGroups.map(g => g.category))], [masterGroups]);

    // ⚡ Bolt: Memoize filtered and sorted groups. Hoist toLowerCase() to prevent
    // redundant O(N*M) string allocations inside the filter loops during search.
