...
export default function Gallery() {
    ...
    // ⚡ BOLT OPTIMIZATION: Wrapped expensive list filtering and sorting in useMemo, hoisted search lowercase outside loop, and mutated the filtered array in-place. Impact: Prevents redundant O(n log n) sorts on re-renders and reduces string parsing overhead.
