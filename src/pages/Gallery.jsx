...
export default function Gallery() {
    ...
    const filteredGroups = useMemo(() => {
        // Hoist invariant search string conversion to prevent redundant recalculation in loop
        const searchLower = search.toLowerCase();

        return masterGroups.filter(group => {
            // Early return: prioritize simple category equality check to short-circuit expensive string operations
