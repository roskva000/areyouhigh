...
export default function Gallery() {
    ...
    // ⚡ Bolt: Memoize categories to avoid recreating the Set on every render
    const categories = useMemo(() => {
        return ['All', ...new Set(masterGroups.map(g => g.category))];
    }, [masterGroups]);

    // ⚡ Bolt: Memoize filter and sort operations to prevent unnecessary recalculations.
    // Pulled search.toLowerCase() outside the loop for O(n) string conversions instead of O(n*m).
