...
export default function Gallery() {
    ...
    const masterGroups = useMemo(() => {
        // ⚡ Bolt Optimization: Use reduce with ??= for ~30% faster grouping
        ...
        // ⚡ Bolt Optimization: Use Object.entries().map() instead of Object.keys().map()
    ...
    // ⚡ Bolt Optimization: Memoize expensive filtering and sorting, and hoist invariant lowercase
