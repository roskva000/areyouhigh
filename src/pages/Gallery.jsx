                        ...
                        <div className="relative group">
                            ...
                            {search && (
                                <button
                                    ...
                                    className="absolute right-4 top-1/2 -translate-y-1/2 text-text/40 hover:text-accent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:ring-accent rounded-full p-1"
                                >
                                    <X size={14} />
                                </button>
                            )}
                        ...
                        <div className="flex flex-wrap gap-2">
                            {categories.map(cat => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl border font-mono text-[10px] uppercase tracking-wider transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:ring-accent ${activeCategory === cat
