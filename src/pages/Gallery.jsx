...
export default function Gallery() {
    ...
    // Optimize: Memoize filtering and sorting to prevent expensive recalculations on every render.
    // Also hoist invariant toLowerCase() conversion outside the loop.
