...
export default function Gallery() {
    ...
    // OPTIMIZATION: Memoize categories generation to avoid recalculating Set on every render
    const categories = useMemo(() => {
        return ['All', ...new Set(masterGroups.map(g => g.category))];
    }, [masterGroups]);

    // OPTIMIZATION: Memoize filter and sort operations. Hoist search.toLowerCase() outside the iteration
