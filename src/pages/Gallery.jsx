...
export default function Gallery() {
    ...
    // Bolt: Memoize categories to prevent redundant Set creation on every search/filter change
    const categories = useMemo(() => {
        return ['All', ...new Set(masterGroups.map(g => g.category))];
    }, [masterGroups]);

    // Bolt: Memoize filteredGroups and hoist search.toLowerCase() to avoid redundant string operations
    const filteredGroups = useMemo(() => {
        if (!search && activeCategory === 'All') return masterGroups;
