...
export default function Gallery() {
    ...
    // ⚡ Bolt: Memoize categories derivation
    const categories = useMemo(() => {
        return ['All', ...new Set(masterGroups.map(g => g.category))];
    }, [masterGroups]);

    // ⚡ Bolt: Memoize filtering and hoist search conversion outside the loop
    ...
    // ⚡ Bolt: Memoize sorting to prevent unnecessary recalcs on render
