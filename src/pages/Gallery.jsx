...
export default function Gallery() {
    ...
    // ⚡ Bolt Optimization: Memoized filter and sort operations. Hoisted `search.toLowerCase()` to prevent repeated string allocation. Implemented short-circuit evaluation to check cheap category equality before expensive string operations.
