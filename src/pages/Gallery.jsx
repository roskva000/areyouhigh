...
export default function Gallery() {
    ...
    // ⚡ Bolt: Memoized category extraction to prevent recalculation on every render
    const categories = useMemo(() => ['All', ...new Set(masterGroups.map(g => g.category))], [masterGroups]);

    // ⚡ Bolt: Memoized filtering and hoisted lowerSearch to avoid redundant string conversions inside the loop
    ...
    // ⚡ Bolt: Memoized sorting primarily by likes (descending) to avoid resorting on unaffected renders
