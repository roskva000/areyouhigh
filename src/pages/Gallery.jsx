...
export default function Gallery() {
    ...
    const filteredGroups = useMemo(() => {
        ...
        return masterGroups.filter(group => {
            ...
            // Check cheap exact match first before expensive string operations
    ...
    // ⚡ Bolt Optimization: Memoize sorting to prevent unnecessary recalculations on unrelated renders
