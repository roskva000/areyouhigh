...
export default function MasterCollection() {
    ...
    // Memoize the filtering of the globally loaded EXPERIENCES array and the
    // string manipulation for the title. This prevents expensive redundant
    // recalculations during unrelated re-renders (like GSAP animations).
