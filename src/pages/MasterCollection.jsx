...
export default function MasterCollection() {
    ...
    // ⚡ Bolt: Memoize the filtering of the globally loaded EXPERIENCES array
    // to prevent expensive recalculations during unrelated re-renders.
    ...
    // ⚡ Bolt: Memoize the string manipulation to avoid redundant calculations.
