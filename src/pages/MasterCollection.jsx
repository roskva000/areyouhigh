...
export default function MasterCollection() {
    ...
    // ⚡ Bolt Optimization: Memoize filtering of the global EXPERIENCES array
    // Prevents redundant O(n) filtering on every re-render (e.g., during animations or route changes)
    const variations = useMemo(() => {
        return EXPERIENCES.filter(exp => exp.master === masterId);
    }, [masterId]);

    // ⚡ Bolt Optimization: Memoize string manipulation
    // Prevents unnecessary string splitting, mapping, and joining on every render
