...
export default function MasterCollection() {
    ...
    // ⚡ Bolt: Memoize the filtering to prevent O(N) recalculation on unrelated re-renders
    ...
    // ⚡ Bolt: Memoize the string manipulation to prevent redundant parsing and object creation
