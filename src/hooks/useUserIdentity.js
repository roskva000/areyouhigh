...
const getStoredIdentity = () => {
    ...
    // 🛡️ Sentinel: Validate length of untrusted localStorage data to prevent payload injection
    if (storedId && storedId.length > 50) storedId = storedId.substring(0, 50);
    if (storedNick && storedNick.length > 50) storedNick = storedNick.substring(0, 50);
