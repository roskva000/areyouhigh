...
const getStoredIdentity = () => {
    ...
    // Security: Validate untrusted input from localStorage
    if (typeof storedId === 'string') storedId = storedId.slice(0, 50);
    if (typeof storedNick === 'string') storedNick = storedNick.slice(0, 50);
