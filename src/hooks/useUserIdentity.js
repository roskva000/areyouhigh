...
const getStoredIdentity = () => {
    ...
    // Security: Validate and limit length of untrusted localStorage data to prevent payload injection
    if (storedId && storedId.length > 50) storedId = null;
    if (storedNick && storedNick.length > 50) storedNick = null;
