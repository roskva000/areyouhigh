...
const getStoredIdentity = () => {
    ...
    // Untrusted input: Limit length to prevent storage exhaustion or backend payload injection
    if (storedId) storedId = storedId.substring(0, 50);
    if (storedNick) storedNick = storedNick.substring(0, 50);
