...
## 2024-07-07 - Add Content Security Policy
**Vulnerability:** Missing Content-Security-Policy (CSP) header in vercel.json.
**Learning:** The application lacked a foundational defense-in-depth layer, leaving it susceptible to unauthorized external resources or inline execution in the event of an XSS vulnerability.
**Prevention:** Always implement a strict, whitelist-based Content-Security-Policy in deployment configurations to explicitly limit resource sources.
