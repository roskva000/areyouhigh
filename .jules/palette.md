...
## 2026-05-28 - Added Empty State Action
**Learning:** Empty search states without a clear path to recovery can leave users frustrated and stuck.
**Action:** Always provide an actionable 'Clear Filters' button when search/filter results are empty to restore the default view.
