...
## 2024-10-24 - Actionable Empty States
**Learning:** Search or filter empty states without a clear recovery path leave users stranded.
**Action:** Always provide an actionable 'Clear Filters' button to allow users to recover and restore the default view.
